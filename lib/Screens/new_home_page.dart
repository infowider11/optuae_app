        ...
        itemBuilder: (context, childIndex){
          ...
          return Padding(
            ...
            child: Row(
              ...
              children: [
                Expanded(child: ProductCard(productDetails: tempProductsList[(childIndex-1)*2],)),
                hSizedBox,
                hSizedBox05,
                Expanded(child: ProductCard(productDetails: tempProductsList[((childIndex-1)*2)+1],)),
    ...
    if(brand!=null){
      totalProducts.forEach((element) {
        ...
        if(showOutOfStockOnly){
          otherCondition = element.stockStatus!='В наличии';
        ...
        if((element.name.toLowerCase().contains(keyword.toLowerCase())||
            element.brand.toLowerCase().contains(keyword.toLowerCase()) || element.partNumber.toLowerCase().contains(keyword.toLowerCase())
            || element.model.toLowerCase().contains(keyword.toLowerCase())) && element.brand==brand && otherCondition)
        {
          tempProductsList.add(element);
     ...
     totalProducts.forEach((element) {
       ...
       if((element.name.toLowerCase().contains(keyword.toLowerCase())||
           element.brand.toLowerCase().contains(keyword.toLowerCase()) || element.partNumber.toLowerCase().contains(keyword.toLowerCase())
           || element.model.toLowerCase().contains(keyword.toLowerCase())) && otherCondition){
         tempProductsList.add(element);
              ...
              children: [
                ...
                GestureDetector(
                  onTap: ()async{
                    ...
                    print('the profuc is ${totalProducts.length}');
                    // globel_timer?.cancel();
                ...
                ValueListenableBuilder<bool>(
                  ...
                  builder: (context, load, child){
                    print(' i am getting reloaded with $tempProductsList');
                    if(load){
                      return CustomLoader();
                    }
