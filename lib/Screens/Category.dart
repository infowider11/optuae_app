        ...
        child: Padding(
          ...
          child: Column(
              ...
              children:[
                ...
                Text("Category List" , style: MyStyle.black70030,),
                ...
                box('Hood Damper',),
                SizedBox(height: size_height*0.02,),
                box( 'Suspension Damper',),
                SizedBox(height: size_height*0.02,),
                box( 'Longitudinal beam under the internal\ncombustion engine',),
                SizedBox(height: size_height*0.02,),
                box( 'Bumper',),
                SizedBox(height: size_height*0.02,),
                box( 'Expansion tank',),
                SizedBox(height: size_height*0.02,),
                box('Washer reservoir',),
                SizedBox(height: size_height*0.02,),
                box( 'ABS block',),
                SizedBox(height: size_height*0.02,),
                box('Immobilizer block',),
                SizedBox(height: size_height*0.02,),
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text(label, style: TextStyle(fontSize: 13, fontWeight: FontWeight.w400, fontFamily: "poppins", color: MyColors.black) ,),
