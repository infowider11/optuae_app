...
import 'package:optuae/services/cart_manage.dart';
...
class willPickUp extends StatefulWidget {
  const willPickUp({Key? key}) : super(key: key);

  @override
  State<willPickUp> createState() => _willPickUpState();
}

class _willPickUpState extends State<willPickUp> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("I'll pick it up myself", style: MyStyle.black60030,),
